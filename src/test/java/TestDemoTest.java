...
class TestDemoTest {
	...
	static Stream<Arguments> argumentsForAddPositive() {
		...
		return Stream.of(
		        ...
		        Arguments.arguments(-4, 5, 1, false),
		        Arguments.arguments(-5, 5, 0, true),
		        Arguments.arguments(-6, 2, -4, true)
		    );
	}
	/*
	 *This method tests "randomNumberSquared()". It creates a mock of "TestDemo" using "Mokito" spy.
	 *The mocked "TestDemo" object is then programmed to return 5 when the "getRandomInt()" method is called.
	 */
	@Test
